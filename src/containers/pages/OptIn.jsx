  ...
  const onSubmit = (e) => {
    ...
    const fetchData = async () => {
      ...
      const res = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/contact/opt-in`,
        formData,
        config
      );
                ...
                <div className="mt-10">
                  ...
                  >
                    ...
                    <div className="mt-4 sm:mt-0 sm:ml-3">
                      {loading ? (
                        <div className="relative inline-flex items-center rounded-md border border-transparent bg-orange-600 px-5 py-3 text-lg font-medium text-white shadow-sm hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
                          Sending
                          <CircleLoader
                            loading={loading}
                            size={25}
